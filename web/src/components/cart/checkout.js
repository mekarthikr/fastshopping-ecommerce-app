        ...
        <div className="col-md-6">
          <form autoComplete="off">
            ...
            <div className="row">
              <div className="form-group col-md-12">
                <label>CITY</label>
                <input className="form-control form-input" type={"text"} name="city" />
              </div>
            </div>
            <div className="row">
              <div className="form-group col-md-4">
                <label>COUNTRY</label>
                <input className="form-control form-input" type={"text"} name="country" />
              </div>
              <div className="form-group col-md-4">
                <label>STATE</label>
                <input className="form-control form-input" type={"text"} name="state" />
              </div>
              <div className="form-group col-md-4">
                <label>PINCODE</label>
                <input className="form-control form-input" type={"number"} name="pincode" />
              </div>
            </div>
