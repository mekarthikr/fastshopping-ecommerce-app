				...
				<div className="row">
					<div className="col">
						<div className="form-group row">
							...
							<input className="form-control form-input" ype={"text"} name="name" value={name || ""} onChange={handleInputChange} />
						</div>
						<div className="form-group row">
						...
						<div className="form-group row">
							...
							<select class="form-select form-control" onChange={handleInputChange} name="category" >
								<option selected value=""> Select any category </option>
						...
						<div className="form-group row">
							...
							<textarea style={{ resize: "none" }} rows={5} className="form-control form-input" type={"text"} name="description" value={description || ""} onChange={handleInputChange}>
							</textarea>
						</div>
					</div>
