  ...
  return (
    <div className="cart-container">
      ...
      <div className="register-block">
        <h1>Hi Fellow Stranger</h1>
        <p>Please enter your details to create a new account</p>
        <form onSubmit={handleSubmit} autoComplete="off">
          <div className="row">
            <div className="form-group col-md-6">
              <label>FIRST NAME</label>
              <input className="form-control form-input" type={"text"} name="firstname" onChange={handleInputChange} onBlur={ValidateRegister} />
              <p className="register-error ">{firstnameError}</p>
            </div>
            <div className="form-group col-md-6">
              <label>LAST NAME</label>
              <input className="form-control form-input" type={"text"} name="lastname" onChange={handleInputChange} />
          ...
          <div className="row">
            ...
            <div className="form-group col-md-6">
              ...
              <input className="form-control form-input" type={"text"} name="phonenumber" onChange={handleInputChange} />
          ...
          <div className="row">
            ...
            <div className="form-group col-md-6">
              ...
              <input className="form-control form-input" type={"password"} name="confirmpassword" onChange={handleInputChange} />
              <p className="register-error ">{passwordConfirmError}</p>
            </div>
          </div>
          <div className="form-group col-md-12">
            <label className="color-white">CATEGORY</label>
            <select class="form-select form-control" onChange={handleInputChange} name="role">
          ...
          <div style={{ margin: "0 33% 0 33%" }} className="form-check">
            ...
            <label className="form-check-label"> By checking here, you agree to our{" "}
              <a href="https://mekarthikr.github.io/dummytext/" target="_blank" style={{ textDecoration: "none", color: "black" }} >
                {" "}
                <strong>
                  T<span>&#38;</span>C
                </strong>
